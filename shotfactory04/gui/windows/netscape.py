...
"""
GUI-specific interface functions for Netscape on Microsoft Windows.
"""
...
class Gui(windows.Gui):
    """
    Special functions for Netscape on Windows.
    """
    ...
    def start_browser(self, config, url, options):
        ...
        """
        command = config['command'] or r'C:\Program Files (x86)\Netscape\Navigator 9\navigator.exe'
    ...
    def find_scrollable(self):
        ...
        for dummy in range(20):
            ...
            if self.verbose >= 3:
                ...
                print
            if win32gui.GetClassName(hwnd) == 'NetscapeWindowClass':
                return hwnd
